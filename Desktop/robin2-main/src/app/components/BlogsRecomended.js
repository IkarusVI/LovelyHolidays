...
export default function BlogsRecomended() {
  ...
  return (
    <div className="relative min-h-[100vh] font-grotesk  pt-10">
      <div className="absolute left-0 bottom-8 h-[500px] lg:h-[650px]">
        <img
            src="download.png"
      ...
      <div className="absolute bottom-0 bg-[#EFFF11] w-full text-[#10100E] overflow-hidden">
        <motion.div
      ...
      <div id="blog" className="py-2 md:pt-20 pl-8 md:pl-[250px] pb-4 flex gap-y-1 flex-col relative z-10 text-white">
        <h2 className="text-4xl lg:text-6xl font-bold pr-8">
          OTROS ARTICULOS
        </h2>
        <div className="flex gap-x-2 pr-8">
          <p className="font-mono text-[#EFFF11] pt-[1px]">(BLOG)</p>
          <p className="font-light text-lg pb-6 lg:pb-14">
            Articulos relacionados que podrían interesarse
          </p>
        </div>
